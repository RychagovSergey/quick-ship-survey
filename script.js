...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        // Add courier qualities as a single field
        const courierQualities = [];
        document.querySelectorAll('input[name="courierQualities[]"]:checked').forEach(checkbox => {
            courierQualities.push(checkbox.value);
        });
        formData.delete('courierQualities[]');
        formData.append('courierQualities', courierQualities.join(', '));
